...
public class Serveur {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException, KeyStoreException, FileNotFoundException, UnrecoverableKeyException, KeyManagementException {
        try {
            ...
            Referendum r2 = new Referendum("Vincent revient à Montpellier ?", new Date(2024 - 1900, Calendar.DECEMBER, 7, 13, 2));
            Referendum r3 = new Referendum("Ouverture BL3 ?", new Date(2024 - 1900, Calendar.DECEMBER, 27, 14, 58));
