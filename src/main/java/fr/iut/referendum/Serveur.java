...
public class Serveur {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException, KeyStoreException, FileNotFoundException, UnrecoverableKeyException, KeyManagementException {
        try {
            ...
            Referendum r2 = new Referendum("Vincent revient à Montpellier ?", new Date(2028 - 1900, Calendar.FEBRUARY, 29, 20, 0));
            Referendum r3 = new Referendum("Ouverture BL3 ?", new Date(2024 - 1900, Calendar.NOVEMBER, 12, 17, 38));
